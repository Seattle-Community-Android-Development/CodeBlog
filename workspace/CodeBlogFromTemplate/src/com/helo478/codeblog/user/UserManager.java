...
public interface UserManager {
	...
	UserAccount createUser(String userName, byte[] passwordHash)
			throws UserManagerException, InvalidUserException;
	...
	boolean changePassword(UserAccount userAccount, byte[] oldPasswordHash,
			byte[] newPasswordHash) throws InvalidPasswordException;

	/**
	 * Get a list of the names of all users who are bloggers.
	 * 
	 ...
	 *             the user manager exception
	 */
	List<String> getBloggersNamesList() throws UserManagerException;
	 ...
	 * @throws InvalidUserException
	 */
	BlogFeed getFeed(String userName) throws UserManagerException,
